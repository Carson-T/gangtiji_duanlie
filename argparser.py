...
def args_parser():
    ...
    parser.add_argument('--lr', type=list, default=[0.0005, 0.001])
    ...
    parser.add_argument('--lr_scheduler', default="Warm-up-Cosine-Annealing")  #Warm-up-Cosine-Annealing
    parser.add_argument('--backbone', default="resnet50.tv_in1k")  # convnextv2_nano.fcmae_ft_in1k  resnet50.tv_in1k
    parser.add_argument('--model_name',  default="resnet50-J-v3")
    ...
    parser.add_argument('--log_dir', default="../log/resnet")
