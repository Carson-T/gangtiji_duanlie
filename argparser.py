...
def args_parser():
    ...
    parser.add_argument('--train_csv_path', default="../data_3subimg/TrainSet/断裂/csv/train_fold1.csv")  # train csv path
    parser.add_argument('--val_csv_path',  default="../data_3subimg/TrainSet/断裂/csv/val_fold1.csv")   # test csv path
    ...
    parser.add_argument('--pretrained_path', default="../saved_model/efficientnet/efficientnetv2_s-3subimg-side-v3.pth")
    parser.add_argument('--backbone', default="efficientnetv2_rw_s.ra2_in1k")  # efficientnetv2_rw_s.ra2_in1k  convnextv2_nano.fcmae_ft_in1k  resnet50.tv_in1k
    parser.add_argument('--model_name',  default="efficientnetv2_s-3subimg-side-v3")  # model version
    ...
    parser.add_argument('--log_dir', default="../log/efficientnet")  # tensorboard log path
