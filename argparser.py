...
def args_parser():
    ...
    parser.add_argument('--model_name',  default="resnet50-J-fold1-v1")
    ...
    parser.add_argument('--saved_path', default='../saved_model/J/resnet')
    parser.add_argument('--ckpt_path', default='../checkpoints/J/resnet')
    parser.add_argument('--log_dir', default="../log/J/resnet")
