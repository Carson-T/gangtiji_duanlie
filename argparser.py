...
def args_parser():
    ...
    parser.add_argument('--lr', type=list, default=[0.0005, 0.0005])
    parser.add_argument('--weight_decay', type=float, default=0.01)
    parser.add_argument('--init_ratio', type=float, default=0.1)       # Warm-up-Cosine-Annealing parameters
    parser.add_argument('--min_lr_ratio', type=float, default=0.005)    # Warm-up-Cosine-Annealing parameters
    ...
    parser.add_argument('--model_name',  default="efficientnetv2_s-3subimg-side-v2")  # model version
