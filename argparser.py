...
def args_parser():
    ...
    parser.add_argument('--resize_h', type=int, default=200)
    parser.add_argument('--resize_w', type=int, default=400)
    ...
    parser.add_argument('--backbone', default="convnextv2_nano.fcmae_ft_in1k")  # convnextv2_nano.fcmae_ft_in1k  mobilenetv3_large_100.ra_in1k  mobilenetv3_small_100.lamb_in1k
    parser.add_argument('--model_name',  default="convnext-test")
    ...
    parser.add_argument('--log_dir', default="../tf-logs/convnext")
