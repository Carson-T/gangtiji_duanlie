...
def args_parser():
    ...
    parser.add_argument('--resize_w', type=int, default=442)
    ...
    parser.add_argument('--lr', type=list, default=[0.001, 0.01])
    ...
    parser.add_argument('--model_name',  default="test")  # model version
    ...
    parser.add_argument('--saved_path', default='../saved_model/J/efficientnet')   # model saved path
    parser.add_argument('--ckpt_path', default='../checkpoints/J/efficientnet')  # checkpoints path for resume
    parser.add_argument('--log_dir', default="../log/J/efficientnet")  # tensorboard log path
    parser.add_argument('--metrics_log_path', default="../logs.csv")
