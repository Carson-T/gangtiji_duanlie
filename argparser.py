...
def args_parser():
    ...
    parser.add_argument('--lr', type=list, default=[0.0008, 0.001])
    ...
    parser.add_argument('--pretrained_path', default="../../pretrained_model/vit_base_patch16_224.augreg_in21k_ft_in1k.safetensors")
    parser.add_argument('--model_name', default="MyVit_gray")
    parser.add_argument('--backbone', default="vit_base_patch16_224.augreg_in21k_ft_in1k")  # vit_small_patch16_224.augreg_in21k_ft_in1k  efficientnetv2_rw_s.ra2_in1k  convnextv2_nano.fcmae_ft_in1k  resnet50.tv_in1k
    parser.add_argument('--version_name',  default="vit_b-3subimg-new_data-four-concat-v2")  # models version
    parser.add_argument('--data_path',  default="../data_3subimg")  # test data path
    parser.add_argument('--saved_path', default='../saved_model/vit')   # models saved path
    parser.add_argument('--ckpt_path', default='../checkpoints/vit')  # checkpoints path for resume
