...
def args_parser():
    ...
    parser.add_argument('--mode', default="V")  # J: jingxi  V: Valsalva
    ...
    parser.add_argument('--device_ids', type=list, default=[1,3])    # if is_parallel==1, specify the cuda id
    ...
    parser.add_argument('--model_name',  default="convnextv2_n-new_data-V-fold2-v1")  # model version
    parser.add_argument('--train_csv_path', default="../new_data/TrainSet/csv/V_train_fold2.csv")  # train csv path
    parser.add_argument('--val_csv_path',  default="../new_data/TrainSet/csv/V_val_fold2.csv")   # test csv path
    parser.add_argument('--test_path',  default="../new_data/TestSet")  # test data path
    parser.add_argument('--saved_path', default='../saved_model/V/convnext')   # model saved path
    parser.add_argument('--ckpt_path', default='../checkpoints/V/convnext')  # checkpoints path for resume
    parser.add_argument('--log_dir', default="../log/V/convnext")  # tensorboard log path
